...
CREATE TABLE IF NOT EXISTS book(
	...
	book_status boolean comment '文件状态',
...
VALUES
	('attr_type', '[{"id": 0, "value": "-"},{"id": 1, "value": "耽美"},{"id": 2, "value": "言情"},{"id": 3, "value": "魔法斗气"},{"id": 4, "value": "玄幻武侠"},{"id": 5, "value": "都市异能"},{"id": 6, "value": "种田生活"},{"id": 7, "value": "历史军事"},{"id": 8, "value": "竞技游戏"},{"id": 9, "value": "未来星际"}]'),
	...
	('attr_status', '[{"id": 1, "value": "通过"},{"id": 2, "value": "待审核"},{"id": 3, "value": "侵权"},{"id": 99, "value": "待删除"}]');